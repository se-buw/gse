...
-   *com.vogella.emf.webpage.model.webpage* --- Interfaces and the Factory to create the Java classes

-   *com.vogella.emf.webpage.model.webpage.impl* --- Concrete implementation of the interfaces defined in model

-   *com.vogella.emf.webpage.model.webpage.util* --- The AdapterFactory
